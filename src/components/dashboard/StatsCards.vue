...
<template>
  <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 lg:grid-cols-4">
    <div class="bg-surface rounded-xl border border-border p-3 sm:p-4">
      ...
      <p class="text-xl sm:text-2xl font-bold text-text-primary">{{ activeCount }}</p>
    </div>
    <div class="bg-surface rounded-xl border border-border p-3 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3 mb-2">
      ...
      <p class="text-xl sm:text-2xl font-bold text-text-primary">{{ fmt(totalMonthly) }}</p>
    </div>
    <div class="bg-surface rounded-xl border border-border p-3 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3 mb-2">
      ...
      <p class="text-xl sm:text-2xl font-bold text-text-primary">{{ fmt(totalYearly) }}</p>
    </div>
    <div class="bg-surface rounded-xl border border-border p-3 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3 mb-2">
      ...
      <p class="text-xl sm:text-2xl font-bold text-text-primary">{{ fmt(amountDue) }}</p>
    </div>
    <div class="bg-surface rounded-xl border border-border p-3 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3 mb-2">
      ...
      <p class="text-xl sm:text-2xl font-bold text-text-primary">{{ fmt(avgMonthly) }}</p>
    </div>
    <div v-if="mostExpensive" class="bg-surface rounded-xl border border-border p-3 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3 mb-2">
      ...
      <p class="text-xl sm:text-2xl font-bold text-text-primary">{{ fmt(mostExpensive.price) }}</p>
      <p class="text-[10px] sm:text-xs text-primary font-medium truncate">{{ mostExpensive.name }}</p>
    </div>
    <div v-if="budgetUsed !== null" class="bg-surface rounded-xl border border-border p-3 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3 mb-2">
      ...
      <p class="text-xl sm:text-2xl font-bold text-text-primary">{{ fmtPercent(budgetUsed || 0) }}</p>
    </div>
    <div v-if="totalSavings > 0" class="bg-surface rounded-xl border border-border p-3 sm:p-4">
      <div class="flex items-center gap-2 sm:gap-3 mb-2">
