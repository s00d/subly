...
<template>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
    ...
    <div class="bg-surface rounded-xl border border-border p-3 sm:p-5">
      <h3 class="text-xs sm:text-sm font-semibold text-text-primary mb-3 sm:mb-4">{{ t('forecast') }}</h3>
      <div class="space-y-3 sm:space-y-4">
        <div>
          ...
          <p class="text-xl sm:text-2xl font-bold text-text-primary">{{ fmt(forecast.nextMonth) }}</p>
        </div>
        <div class="pt-3 border-t border-border">
          ...
          <p class="text-lg sm:text-xl font-bold text-text-primary">{{ fmt(forecast.nextQuarter) }}</p>
    ...
    <!-- Month comparison -->
    <div class="bg-surface rounded-xl border border-border p-3 sm:p-5">
      <h3 class="text-xs sm:text-sm font-semibold text-text-primary mb-3 sm:mb-4">{{ t('month_comparison') }}</h3>
      <div class="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
        <div class="flex-1 text-center">
          <p class="text-[10px] sm:text-xs text-text-muted mb-1">{{ comparison.previousMonth }}</p>
          <p class="text-base sm:text-lg font-bold text-text-primary">{{ fmt(comparison.previous) }}</p>
        </div>
        ...
        <div class="flex-1 text-center">
          ...
          <p class="text-base sm:text-lg font-bold text-text-primary">{{ fmt(comparison.current) }}</p>
        </div>
      </div>
      <div
